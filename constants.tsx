...
export const Icons = {
  Tractor: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="m10 11 11 0"/><path d="M7 15a3 3 0 1 0 0 6 3 3 0 0 0 0-6z"/><path d="M20 15a3 3 0 1 0 0 6 3 3 0 0 0 0-6z"/><path d="M10 15v6"/><path d="M10 11V5a1 1 0 0 1 1-1h4"/><path d="M7 15V9a1 1 0 0 1 1-1h9a1 1 0 0 1 1 1v6"/></svg>
  ),
  Cow: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M14 13V5a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h8"/><path d="M10 11H6"/><path d="M14 13h4a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2h-4"/><path d="M10 17v4"/><path d="M6 17v4"/></svg>
  ),
  Pig: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M19 14c1.1 0 2 .9 2 2v4c0 1.1-.9 2-2 2h-2c-1.1 0-2-.9-2-2v-2h-6v2c0 1.1-.9 2-2 2H5c-1.1 0-2-.9-2-2v-5c0-2.8 2.2-5 5-5h1c.6-1.5 2-2.5 3.5-2.5s3 1 3.5 2.5h2.5c2.5 0 4.5 2 4.5 4.5z"/><path d="M10 13a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3z"/></svg>
  ),
  Chicken: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M16 14.5a3.5 3.5 0 1 0-2.5-6.3"/><path d="M7 11.5a3.5 3.5 0 1 1 5.6 4.3"/><path d="M13 19h-2"/><path d="M8 19h-2"/><path d="M10.5 16.5c-1.5 2-4 2.5-6 1.5 1.5-2.5 3.5-2.5 4.5-2"/><path d="M16 11c1.5 0 3-1 3-2.5"/></svg>
  ),
